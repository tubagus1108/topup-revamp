    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="sendSaldo">
                ...
                <button type="button" class="btn btn-danger" id="submitSendSaldo">Kirim</button>
            </form>
        </div>
    </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#submitSendSaldo').on('click', function() {
                alert('tes')
            });
            ...
            $('#datatable').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{ route('datatable.members') }}", // Ganti dengan URL data Anda
                "columns": [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
