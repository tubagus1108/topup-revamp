            ...
            $('#submitAddMember').on('click', function() {
                $.ajax({
                    ...
                    success: function(response) {
                        // Clear form fields
                        $('#addMemberForm input[type="text"], #addMemberForm input[type="email"], #addMemberForm input[type="password"], #addMemberForm input[type="number"]')
                            .val('');
                        $('#addMemberForm select').val(
                            'Member'); // Set default value for select dropdown
                        Swal.fire({
                            icon: 'success',
